...
public:
	...
	virtual void Output(VeStringA& kOutput, VeInt32 i32Depth) const = 0;
	...
	static void EncodeString(const VeStringA& kStr, VeStringA& kOut);
...
protected:
	...
	static const VeChar8* ReadName(const VeChar8* pcStr, VeStringA& kName, VeXMLEncoding eEncoding);

	static const VeChar8* ReadText(const VeChar8* pcStr, VeStringA& kText,
...
public:
	...
	const VeStringA& ValueToStr() const;
...
public:
	...
	virtual void Output(VeStringA& kOutput, VeInt32 i32Depth) const;
...
private:
	VeStringA m_kVersion;
	VeStringA m_kEncoding;
	VeStringA m_kStandalone;
...
public:
	...
	const VeStringA& NameToStr() const;
...
public:
	...
	T Attribute(const VeChar8* pcName, const T& tDefault)
	{
		...
		{
			T kRes;
			bool bRes = VeStringA(pcAttr).To(kRes);
			if(bRes)
			{
				return kRes;
			}
...
public:
	...
	virtual void Output(VeStringA& kOutput, VeInt32 i32Depth = 0) const;
