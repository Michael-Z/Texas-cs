...
public:
	...
	VE_INLINE VeMatrix(const VeFloat32* pf32Matrix);

	VE_INLINE VeMatrix(const VeMatrix& kMatrix);
	...
	VE_INLINE VeMatrix(const VeVector4D& kRow0, const VeVector4D& kRow1, const VeVector4D& kRow2, const VeVector4D& kRow3);
