...
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D()
{
	VeZero4f(VE_FLOAT_POINT_THIS);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(VeFloat32 fX, VeFloat32 fY, VeFloat32 fZ,
	VeFloat32 fW)
{
	VeSet4f(VE_FLOAT_POINT_THIS, fX, fY, fZ, fW);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(const VeFloat32* pf32Vector)
{
	VeCopy4f(VE_FLOAT_POINT_THIS, pf32Vector);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(const VeVector4D& kVector)
{
	VeCopy4f(VE_FLOAT_POINT_THIS, VE_FLOAT_POINT_CONST(&kVector));
}
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(const VeVector2D& kVector, VeFloat32 fZ,
	VeFloat32 fW)
{
	VeSet4f(VE_FLOAT_POINT_THIS, kVector.x, kVector.y, fZ, fW);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(VeFloat32 fX, const VeVector2D& kVector,
	VeFloat32 fW)
{
	VeSet4f(VE_FLOAT_POINT_THIS, fX, kVector.x, kVector.y, fW);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(VeFloat32 fX, VeFloat32 fY,
	const VeVector2D& kVector)
{
	VeSet4f(VE_FLOAT_POINT_THIS, fX, fY, kVector.x, kVector.y);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(const VeVector2D& kVector0,
...
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(const VeVector3D& kVector, VeFloat32 fW)
{
	VeSet4f(VE_FLOAT_POINT_THIS, kVector.x, kVector.y, kVector.z, fW);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector4D::VeVector4D(VeFloat32 fX, const VeVector3D& kVector)
{
