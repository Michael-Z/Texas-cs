...
//--------------------------------------------------------------------------
VE_INLINE VeInputMessage::VeInputMessage()
	: m_eDeviceType(DT_UNASSIGNED), m_u32InputType(0)
	, m_u32InputCode(0), m_pvMessageInfo(NULL)
{

}
//--------------------------------------------------------------------------
VE_INLINE VeInputMessage::VeInputMessage(DeviceType eDeviceType
