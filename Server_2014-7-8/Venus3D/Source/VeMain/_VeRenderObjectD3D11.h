...
class VeROBlendStateD3D11 : public VeROBlendState
{
	VeDeclareRTTI;
public:
	VeROBlendStateD3D11(const VeChar8* pcName, ID3D11BlendState* pkObj);
...
class VeRODepthStencilStateD3D11 : public VeRODepthStencilState
{
	VeDeclareRTTI;
public:
	VeRODepthStencilStateD3D11(const VeChar8* pcName, ID3D11DepthStencilState* pkObj);
...
class VeROInputLayoutD3D11 : public VeROInputLayout
{
	VeDeclareRTTI;
public:
	VeROInputLayoutD3D11(const VeChar8* pcName, ID3D11InputLayout* pkObj);
...
class VeRORasterizeStateD3D11 : public VeRORasterizeState
{
	VeDeclareRTTI;
public:
	VeRORasterizeStateD3D11(const VeChar8* pcName, ID3D11RasterizerState* pkObj);
...
class VeROSamplerStateD3D11 : public VeROSamplerState
{
	VeDeclareRTTI;
public:
	VeROSamplerStateD3D11(const VeChar8* pcName, ID3D11SamplerState* pkObj);
...
class VeROBufferD3D11 : public VeROBuffer
{
	VeDeclareRTTI;
public:
	VeROBufferD3D11(const VeChar8* pcName, ID3D11Buffer* pkObj);
...
class VeRODepthStencilViewD3D11 : public VeRODepthStencilView
{
	VeDeclareRTTI;
public:
	VeRODepthStencilViewD3D11(const VeChar8* pcName, ID3D11DepthStencilView* pkObj);
...
class VeRORenderTargetViewD3D11 : public VeRORenderTargetView
{
	VeDeclareRTTI;
public:
	VeRORenderTargetViewD3D11(const VeChar8* pcName, ID3D11RenderTargetView* pkObj);
...
class VeROShaderResourceViewD3D11 : public VeROShaderResourceView
{
	VeDeclareRTTI;
public:
	VeROShaderResourceViewD3D11(const VeChar8* pcName, ID3D11ShaderResourceView* pkObj);
...
class VeROTexture2DD3D11 : public VeROTexture2D
{
	VeDeclareRTTI;
public:
	VeROTexture2DD3D11(const VeChar8* pcName, ID3D11Texture2D* pkObj);
...
class VeROPixelShaderD3D11 : public VeROPixelShader
{
	VeDeclareRTTI;
public:
	VeROPixelShaderD3D11(const VeChar8* pcName, ID3D11PixelShader* pkObj);
...
class VeROVertexShaderD3D11 : public VeROVertexShader
{
	VeDeclareRTTI;
public:
	VeROVertexShaderD3D11(const VeChar8* pcName, ID3D11VertexShader* pkObj);
