...
public:
	...
	VE_INLINE VeVector3D();

	VE_INLINE VeVector3D(VeFloat32 x, VeFloat32 y, VeFloat32 z);

	VE_INLINE VeVector3D(const VeFloat32* pf32Vector);

	VE_INLINE VeVector3D(const VeVector3D& kVector);

	VE_INLINE VeVector3D(const VeVector3D& kVector, VeFloat32 z);

	VE_INLINE VeVector3D(VeFloat32 x, const VeVector3D& kVector);
