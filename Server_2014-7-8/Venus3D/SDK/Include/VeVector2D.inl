...
//--------------------------------------------------------------------------
VE_INLINE VeVector2D::VeVector2D()
{
	VeZero2f(VE_FLOAT_POINT_THIS);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector2D::VeVector2D(VeFloat32 fX, VeFloat32 fY)
{
	VeSet2f(VE_FLOAT_POINT_THIS, fX, fY);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector2D::VeVector2D(const VeFloat32* pf32Vector)
{
	VeCopy2f(VE_FLOAT_POINT_THIS, pf32Vector);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector2D::VeVector2D(const VeVector2D& kVector)
{
