...
public:
	...
	{
	public:
		VE_INLINE MutexHolder(Mutex& kMutex);

		VE_INLINE ~MutexHolder();
	...
	VE_INLINE VeThread(VeUInt32 u32Priority = VE_THREAD_PRIORITY_NORMAL, VeSizeT stStackSize = 32768);
...
#define VE_AUTO_LOCK_MUTEX(mutex) VeThread::MutexHolder(mutex.GetRef())
