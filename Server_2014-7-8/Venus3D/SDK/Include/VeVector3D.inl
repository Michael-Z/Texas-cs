...
//--------------------------------------------------------------------------
VE_INLINE VeVector3D::VeVector3D()
{
	VeZero3f(VE_FLOAT_POINT_THIS);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector3D::VeVector3D(VeFloat32 fX, VeFloat32 fY, VeFloat32 fZ)
{
	VeSet3f(VE_FLOAT_POINT_THIS, fX, fY, fZ);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector3D::VeVector3D(const VeFloat32* pf32Vector)
{
	VeCopy3f(VE_FLOAT_POINT_THIS, pf32Vector);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector3D::VeVector3D(const VeVector3D& kVector)
{
	VeCopy3f(VE_FLOAT_POINT_THIS, VE_FLOAT_POINT_CONST(&kVector));
}
//--------------------------------------------------------------------------
VE_INLINE VeVector3D::VeVector3D(const VeVector3D& kVector, VeFloat32 fZ)
{
	VeSet3f(VE_FLOAT_POINT_THIS, kVector.x, kVector.y, fZ);
}
//--------------------------------------------------------------------------
VE_INLINE VeVector3D::VeVector3D(VeFloat32 fX, const VeVector3D& kVector)
{
