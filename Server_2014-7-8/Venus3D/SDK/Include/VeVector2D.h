...
public:
	...
	VE_INLINE VeVector2D();

	VE_INLINE VeVector2D(VeFloat32 x, VeFloat32 y);

	VE_INLINE VeVector2D(const VeFloat32* pf32Vector);

	VE_INLINE VeVector2D(const VeVector2D& kVector);
