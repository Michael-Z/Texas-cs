...
void VENet::BitStream::Read( BitStream &bitStream, VENet::VEString &string )
{
	char str[255];
	VENet::StringCompressor::Instance()->DecodeString(str, 255, &bitStream);
	string = str;
}

void VENet::BitStream::Write( BitStream &bitStream, VENet::VEString &string )
{
	const char *str = string.C_String();
	VENet::StringCompressor::Instance()->EncodeString(str, 255 ,&bitStream);
}
