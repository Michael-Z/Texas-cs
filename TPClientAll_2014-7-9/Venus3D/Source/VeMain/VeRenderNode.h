...
{
public:
	VeIAVertexBuffer(const VeChar8* pcName, VeUInt32 u32Stride, VeUInt32 u32Slot);
...
public:
	...
	VeVector<VeColorA> m_kColorArray;
};

class VE_MAIN_API VeDrawCall : public VeRenderCall
{
public:
	VeDrawCall(VeUInt32 u32Count, VeUInt32 u32Location);

	virtual ~VeDrawCall();

	VeUInt32 m_u32Count;
	VeUInt32 m_u32Location;
};

class VE_MAIN_API VeDrawIndexedCall : public VeRenderCall
{
public:
	VeDrawIndexedCall(VeUInt32 u32IndexCount, VeUInt32 u32StartIndex);

	virtual ~VeDrawIndexedCall();

	VeUInt32 m_u32IndexCount;
	VeUInt32 m_u32StartIndex;
};
