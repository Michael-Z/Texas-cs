...
#ifndef _NEW_
	VE_POWER_API void* operator new(VeSizeT stSize, void* pvMemory);
#endif
...
VE_POWER_API void* operator new(VeSizeT stSize, const VeChar8* pcSourceFile, VeInt32 iSourceLine, const VeChar8* pcFunction);
