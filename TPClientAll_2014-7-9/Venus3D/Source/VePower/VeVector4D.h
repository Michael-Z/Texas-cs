...
public:
	...
	VE_INLINE VeVector4D();

	VE_INLINE VeVector4D(VeFloat32 x, VeFloat32 y, VeFloat32 z, VeFloat32 w);

	VE_INLINE VeVector4D(const VeFloat32* pf32Vector);

	VE_INLINE VeVector4D(const VeVector4D& kVector);

	VE_INLINE VeVector4D(const VeVector2D& kVector, VeFloat32 z, VeFloat32 w);

	VE_INLINE VeVector4D(VeFloat32 x, const VeVector2D& kVector, VeFloat32 w);

	VE_INLINE VeVector4D(VeFloat32 x, VeFloat32 y, const VeVector2D& kVector);
	
	VE_INLINE VeVector4D(const VeVector2D& kVector0, const VeVector2D& kVector1);

	VE_INLINE VeVector4D(const VeVector3D& kVector, VeFloat32 w);

	VE_INLINE VeVector4D(VeFloat32 x, const VeVector3D& kVector);
