...
//--------------------------------------------------------------------------
VE_INLINE VeQuaternion::VeQuaternion()
{
	VeZero4f(VE_FLOAT_POINT_THIS);
}
//--------------------------------------------------------------------------
VE_INLINE VeQuaternion::VeQuaternion(VeFloat32 fX, VeFloat32 fY,
	VeFloat32 fZ, VeFloat32 fW)
{
	VeSet4f(VE_FLOAT_POINT_THIS, fX, fY, fZ, fW);
}
//--------------------------------------------------------------------------
VE_INLINE VeQuaternion::VeQuaternion(const VeFloat32* pf32Quat)
{
	VeCopy4f(VE_FLOAT_POINT_THIS, pf32Quat);
}
//--------------------------------------------------------------------------
VE_INLINE VeQuaternion::VeQuaternion(const VeQuaternion& kQuat)
{
	VeCopy4f(VE_FLOAT_POINT_THIS, kQuat);
}
//--------------------------------------------------------------------------
VE_INLINE VeQuaternion::VeQuaternion(const VeVector3D& kVec, VeFloat32 fW)
{
...
//--------------------------------------------------------------------------
VE_INLINE VeVector3D VeQuaternion::operator * (const VeVector3D& kVec)
{
	VeVector3D uv, uuv;
