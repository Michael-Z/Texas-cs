...
//--------------------------------------------------------------------------
VE_INLINE VeAngle::VeAngle() : m_f32Angle(0)
{

}
//--------------------------------------------------------------------------
VE_INLINE VeAngle::VeAngle(const VeAngle& kAngle)
...
//--------------------------------------------------------------------------
VE_INLINE VeAngle::VeAngle(VeFloat32 f32ValueInRadians)
	: m_f32Angle(f32ValueInRadians)
{
	Normalise();
}
//--------------------------------------------------------------------------
VE_INLINE VeAngle::~VeAngle()
{
...
//--------------------------------------------------------------------------
VE_INLINE void VeAngle::Normalise(VeFloat32& f32Angle)
{
	f32Angle = VeNormaliseAnglef(f32Angle);
}
//--------------------------------------------------------------------------
