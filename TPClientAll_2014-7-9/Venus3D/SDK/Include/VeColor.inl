...
//--------------------------------------------------------------------------
VE_INLINE VeColor::VeColor(VeFloat32 fR, VeFloat32 fG, VeFloat32 fB)
{
	VeSet3f(VE_FLOAT_POINT_THIS, fR, fG, fB);
}
//--------------------------------------------------------------------------
VE_INLINE VeColor::operator VeRGBA ()
{
	VeRGBA kRes;
	GetAs(kRes);
	return kRes;
...
//--------------------------------------------------------------------------
VE_INLINE VeColor::operator VeColorA ()
{
	return VeColorA(r, g, b, 1.0f);
}
//--------------------------------------------------------------------------
...
//--------------------------------------------------------------------------
VE_INLINE VeColor& VeColor::operator = (VeFloat32 fScalar)
{
	VeSet3f1(VE_FLOAT_POINT_THIS, fScalar);
	return *this;
}
//--------------------------------------------------------------------------
...
{
	VeColor kRes;
	VeAdd3f((VeFloat32*)&kRes, VE_FLOAT_POINT_THIS, (VeFloat32*)&c);
	return kRes;
}
//--------------------------------------------------------------------------
VE_INLINE VeColor VeColor::operator - (const VeColor& c) const
{
	VeColor kRes;
	VeSub3f((VeFloat32*)&kRes, VE_FLOAT_POINT_THIS, (VeFloat32*)&c);
	return kRes;
}
//--------------------------------------------------------------------------
...
{
	VeColor kRes;
	VeScale3f((VeFloat32*)&kRes, VE_FLOAT_POINT_THIS, f32Scalar);
	return kRes;
}
//--------------------------------------------------------------------------
VE_INLINE VeColor VeColor::operator * (const VeColor& c) const
{
	VeColor kRes;
	VeMul3f((VeFloat32*)&kRes, VE_FLOAT_POINT_THIS, (VeFloat32*)&c);
	return kRes;
}
//--------------------------------------------------------------------------
VE_INLINE VeColor VeColor::operator / (VeFloat32 f32Scalar) const
...
{
	VeColor kRes;
	VeDiv3f((VeFloat32*)&kRes, VE_FLOAT_POINT_THIS, (VeFloat32*)&c);
	return kRes;
}
//--------------------------------------------------------------------------
VE_INLINE VeColor VeColor::operator - () const
{
	return VeColor(-r, -g, -b);
}
//--------------------------------------------------------------------------
...
{
	VeAdd3f(VE_FLOAT_POINT_THIS, VE_FLOAT_POINT_THIS, (VeFloat32*)&c);
	return *this;
}
//--------------------------------------------------------------------------
VE_INLINE VeColor& VeColor::operator -= (const VeColor& c)
{
	VeSub3f(VE_FLOAT_POINT_THIS, VE_FLOAT_POINT_THIS, (VeFloat32*)&c);
	return *this;
}
//--------------------------------------------------------------------------
VE_INLINE VeColor& VeColor::operator *= (VeFloat32 f32Scalar)
{
	VeScale3f(VE_FLOAT_POINT_THIS, VE_FLOAT_POINT_THIS, f32Scalar);
	return *this;
}
//--------------------------------------------------------------------------
VE_INLINE VeColor& VeColor::operator *= (const VeColor& c)
{
	VeMul3f(VE_FLOAT_POINT_THIS, VE_FLOAT_POINT_THIS, (VeFloat32*)&c);
	return *this;
}
//--------------------------------------------------------------------------
VE_INLINE VeColor& VeColor::operator /= (VeFloat32 f32Scalar)
...
VE_INLINE VeColor& VeColor::operator /= (const VeColor& c)
{
	VeDiv3f(VE_FLOAT_POINT_THIS, VE_FLOAT_POINT_THIS, (VeFloat32*)&c);
	return *this;
}
//--------------------------------------------------------------------------
...
{
	kColor.r() = (VeUInt8)(r * 255.0f);
	kColor.g() = (VeUInt8)(g * 255.0f);
	kColor.b() = (VeUInt8)(b * 255.0f);
	kColor.a() = 255;
}
//--------------------------------------------------------------------------
VE_INLINE VeColorA::VeColorA(VeFloat32 fR, VeFloat32 fG, VeFloat32 fB,
	VeFloat32 fA)
{
	VeSet4f(VE_FLOAT_POINT_THIS, fR, fG, fB, fA);
}
//--------------------------------------------------------------------------
VE_INLINE VeColorA::operator VeRGBA ()
{
	VeRGBA kRes;
	GetAs(kRes);
	return kRes;
...
//--------------------------------------------------------------------------
VE_INLINE VeColorA::operator VeColor ()
{
	return VeColor(r, g, b);
}
//--------------------------------------------------------------------------
VE_INLINE VeColorA& VeColorA::operator = (VeFloat32 f32Scalar)
{
	VeSet4f1(VE_FLOAT_POINT_THIS, f32Scalar);
	return *this;
}
//--------------------------------------------------------------------------
VE_INLINE VeColorA::operator VeFloat32* ()
{
	return VE_FLOAT_POINT_THIS;
}
//--------------------------------------------------------------------------
VE_INLINE bool VeColorA::operator == (const VeColorA& c) const
{
...
//--------------------------------------------------------------------------
VE_INLINE VeColorA VeColorA::operator + (const VeColorA& c) const
{
	VeColorA kRes;
...
//--------------------------------------------------------------------------
VE_INLINE VeColorA VeColorA::operator * (VeFloat32 f32Scalar) const
{
	VeColorA kRes;
...
//--------------------------------------------------------------------------
VE_INLINE VeColorA VeColorA::operator - () const
{
	return VeColorA(-r, -g, -b, -a);
}
//--------------------------------------------------------------------------
VE_INLINE VeColorA operator * (VeFloat32 f32Scalar, const VeColorA& c)
{
	return c * f32Scalar;
}
//--------------------------------------------------------------------------
VE_INLINE VeColorA& VeColorA::operator += (const VeColorA& c)
{
...
//--------------------------------------------------------------------------
VE_INLINE void VeColorA::GetAs(VeRGBA& kColor) const
{
	kColor.r() = (VeUInt8)(r * 255.0f);
	kColor.g() = (VeUInt8)(g * 255.0f);
	kColor.b() = (VeUInt8)(b * 255.0f);
	kColor.a() = (VeUInt8)(a * 255.0f);
}
//--------------------------------------------------------------------------
VE_INLINE VeRGBA::VeRGBA(VeUInt8 u8R, VeUInt8 u8G, VeUInt8 u8B, VeUInt8 u8A)
	: m_u32Color(0)
{
	r() = u8R;
	g() = u8G;
...
//--------------------------------------------------------------------------
VE_INLINE VeRGBA::operator VeColorA ()
{
	VeColorA kRes;
	GetAs(kRes);
	return kRes;
...
//--------------------------------------------------------------------------
VE_INLINE void VeRGBA::GetAs(VeColorA& kColor) const
{
	kColor.r = ((VeFloat32)r() / 255.0f);
	kColor.g = ((VeFloat32)g() / 255.0f);
	kColor.b = ((VeFloat32)b() / 255.0f);
