...
public:
	...
	VE_INLINE VeColor(VeFloat32 r = 0.0f, VeFloat32 g = 0.0f, VeFloat32 b = 0.0f);

	VE_INLINE operator VeRGBA ();

	VE_INLINE operator VeColorA ();
...
class VE_POWER_API VeColorA : public VeMemObject
{
public:
	VeFloat32 r, g, b, a;

	VE_INLINE VeColorA(VeFloat32 r = 0.0f, VeFloat32 g = 0.0f, VeFloat32 b = 0.0f, VeFloat32 a = 0.0f);
	...
	VE_INLINE VeColorA& operator = (VeFloat32 f32Scalar);

	VE_INLINE bool operator == (const VeColorA& c) const;

	VE_INLINE bool operator != (const VeColorA& c) const;

	VE_INLINE VeColorA operator + (const VeColorA& c) const;

	VE_INLINE VeColorA operator - (const VeColorA& c) const;

	VE_INLINE VeColorA operator * (VeFloat32 f32Scalar) const;
	...
	VE_INLINE VeColorA operator - () const;

	friend VE_POWER_INLINE VeColorA operator * (VeFloat32 f32Scalar, const VeColorA& c);

	VE_INLINE VeColorA& operator += (const VeColorA& c);
	...
	static const VeColorA WHITE;
	static const VeColorA BLACK;
};

class VE_POWER_API VeRGBA : public VeMemObject
{
public:
	VE_INLINE VeRGBA(VeUInt8 r = 0, VeUInt8 g = 0, VeUInt8 b = 0, VeUInt8 a = 0);
	...
	VE_INLINE void GetAs(VeColorA& kColor) const;
