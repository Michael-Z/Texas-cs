...
SystemAddress Rackspace::Authenticate(TCPInterface *_tcpInterface, const char *_authenticationURL, const char *_rackspaceCloudUsername, const char *_apiAccessKey)
{
    ...
    VEAssert(tcpInterface->WasStarted());
...
void Rackspace::AddOperation(RackspaceOperationType type, VENet::VEString httpCommand, VENet::VEString operation, VENet::VEString xml)
{
    RackspaceOperation ro;
    ro.type=type;
...
void Rackspace::CreateServer(VENet::VEString name, VENet::VEString imageId, VENet::VEString flavorId)
{
    VENet::VEString xml(
...
void Rackspace::GetServerDetails(VENet::VEString serverId)
{
    AddOperation(RO_GET_SERVER_DETAILS, "GET", VENet::VEString("servers/%s", serverId.C_String()), "");
}
void Rackspace::UpdateServerNameOrPassword(VENet::VEString serverId, VENet::VEString newName, VENet::VEString newPassword)
{
    ...
    if (newName.IsEmpty()==false)
        xml += VENet::VEString(" name=\"%s\"", newName.C_String());
    if (newPassword.IsEmpty()==false)
        xml += VENet::VEString(" adminPass=\"%s\"", newPassword.C_String());
    xml += " />";
    AddOperation(RO_UPDATE_SERVER_NAME_OR_PASSWORD, "PUT", VENet::VEString("servers/%s", serverId.C_String()), xml);
}
void Rackspace::DeleteServer(VENet::VEString serverId)
{
    AddOperation(RO_DELETE_SERVER, "DELETE", VENet::VEString("servers/%s", serverId.C_String()), "");
}
void Rackspace::ListServerAddresses(VENet::VEString serverId)
{
    AddOperation(RO_LIST_SERVER_ADDRESSES, "GET", VENet::VEString("servers/%s/ips", serverId.C_String()), "");
}
void Rackspace::ShareServerAddress(VENet::VEString serverId, VENet::VEString ipAddress)
{
    AddOperation(RO_SHARE_SERVER_ADDRESS, "PUT", VENet::VEString("servers/%s/ips/public/%s", serverId.C_String(), ipAddress.C_String()), "");
}
void Rackspace::DeleteServerAddress(VENet::VEString serverId, VENet::VEString ipAddress)
{
    AddOperation(RO_DELETE_SERVER_ADDRESS, "DELETE", VENet::VEString("servers/%s/ips/public/%s", serverId.C_String(), ipAddress.C_String()), "");
}
void Rackspace::RebootServer(VENet::VEString serverId, VENet::VEString rebootType)
{
    VENet::VEString xml(
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
    ...
    AddOperation(RO_REBOOT_SERVER, "POST", VENet::VEString("servers/%s/action", serverId.C_String()), xml);
}
void Rackspace::RebuildServer(VENet::VEString serverId, VENet::VEString imageId)
{
    VENet::VEString xml(
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
    ...
    AddOperation(RO_REBUILD_SERVER, "POST", VENet::VEString("servers/%s/action", serverId.C_String()), xml);
}
void Rackspace::ResizeServer(VENet::VEString serverId, VENet::VEString flavorId)
{
    VENet::VEString xml(
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
    ...
    AddOperation(RO_RESIZE_SERVER, "POST", VENet::VEString("servers/%s/action", serverId.C_String()), xml);
}
void Rackspace::ConfirmResizedServer(VENet::VEString serverId)
{
    VENet::VEString xml(
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
        "<confirmResize xmlns=\"http://docs.rackspacecloud.com/servers/api/v1.0\" "
        "/>");
    AddOperation(RO_CONFIRM_RESIZED_SERVER, "POST", VENet::VEString("servers/%s/action", serverId.C_String()), xml);
}
void Rackspace::RevertResizedServer(VENet::VEString serverId)
{
    VENet::VEString xml(
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
        "<revertResize xmlns=\"http://docs.rackspacecloud.com/servers/api/v1.0\" "
        "/>");
    AddOperation(RO_REVERT_RESIZED_SERVER, "POST", VENet::VEString("servers/%s/action", serverId.C_String()), xml);
}
void Rackspace::ListFlavors(void)
{
    AddOperation(RO_LIST_FLAVORS, "GET", "flavors", "");
}
void Rackspace::GetFlavorDetails(VENet::VEString flavorId)
{
    AddOperation(RO_GET_FLAVOR_DETAILS, "GET", VENet::VEString("flavors/%s", flavorId.C_String()), "");
}
void Rackspace::ListImages(void)
{
    AddOperation(RO_LIST_IMAGES, "GET", "images", "");
}
void Rackspace::CreateImage(VENet::VEString serverId, VENet::VEString imageName)
{
    VENet::VEString xml(
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
...
void Rackspace::GetImageDetails(VENet::VEString imageId)
{
    AddOperation(RO_GET_IMAGE_DETAILS, "GET", VENet::VEString("images/%s", imageId.C_String()), "");
}
void Rackspace::DeleteImage(VENet::VEString imageId)
{
    AddOperation(RO_DELETE_IMAGE, "DELETE", VENet::VEString("images/%s", imageId.C_String()), "");
}
...
void Rackspace::CreateSharedIPGroup(VENet::VEString name, VENet::VEString optionalServerId)
{
    VENet::VEString xml(
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
        "<sharedIpGroup xmlns=\"http://docs.rackspacecloud.com/servers/api/v1.0\" name=\"%s\">", name.C_String());
    if (optionalServerId.IsEmpty()==false)
        xml+=VENet::VEString("<server id=\"%s\"/>", optionalServerId.C_String());
    xml+="</sharedIpGroup>";

    AddOperation(RO_CREATE_SHARED_IP_GROUP, "POST", "shared_ip_groups", xml);
}
void Rackspace::GetSharedIPGroupDetails(VENet::VEString groupId)
{
    AddOperation(RO_GET_SHARED_IP_GROUP_DETAILS, "GET", VENet::VEString("shared_ip_groups/%s", groupId.C_String()), "");
}
void Rackspace::DeleteSharedIPGroup(VENet::VEString groupId)
{
    AddOperation(RO_DELETE_SHARED_IP_GROUP, "DELETE", VENet::VEString("shared_ip_groups/%s", groupId.C_String()), "");
}
void Rackspace::OnClosedConnection(SystemAddress systemAddress)
{
    ...
    while (operationsIndex < operations.Size())
    {
        if (operations[operationsIndex].isPendingAuthentication==false && operations[operationsIndex].connectionAddress==systemAddress)
        {
            ...
            VENet::VEString packetDataString = ro.incomingStream;
...
void Rackspace::ReadLine(const char *data, const char *stringStart, VENet::VEString &output)
{
    output.Clear();
