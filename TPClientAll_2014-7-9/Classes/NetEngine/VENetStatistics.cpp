...
void VE_DLL_EXPORT VENet::StatisticsToString( VENetStatistics *s, char *buffer, int verbosityLevel )
{
    if ( s == 0 )
    {
    ...
    else if (verbosityLevel==1)
    {
        sprintf(buffer,
                ...
                (long long unsigned int) (uint64_t)((VENet::GetTimeUS()-s->connectionStartTime)/1000000)
               );
