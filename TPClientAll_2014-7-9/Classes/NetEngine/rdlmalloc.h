...
#define M_MMAP_THRESHOLD     (-3)
	...
	*/
	...
	the given space.
	*/
	void* ve_mspace_malloc(mspace msp, size_t bytes);
	...
	*/
	void ve_mspace_free(mspace msp, void* mem);
	...
	spaces.
	*/
	void* ve_mspace_realloc(mspace msp, void* mem, size_t newsize);
...
#define CMFAIL               ((char*)(MFAIL)) /* defined for convenience */
	...
	#define VE_MMAP_DEFAULT(s)             win32mmap(s)
	#define VE_MUNMAP_DEFAULT(a, s)        win32munmap((a), (s))
	#define VE_DIRECT_MMAP_DEFAULT(s)      win32direct_mmap(s)
...
#define VE_MMAP_DEFAULT(s) malloc(s);
#define VE_MUNMAP_DEFAULT(a, s) ___freeit_dlmalloc_default__(a);
#define VE_DIRECT_MMAP_DEFAULT(s) malloc(s);

#elif !defined(DL_PLATFORM_WIN32)
	#define VE_MUNMAP_DEFAULT(a, s)  munmap((a), (s))
	...
	#define VE_MMAP_DEFAULT(s)       mmap(0, (s), MMAP_PROT, MMAP_FLAGS, -1, 0)
	#else /* MAP_ANONYMOUS */
	/*
	...
	*/
	...
	#define VE_MMAP_DEFAULT(s) ((dev_zero_fd < 0) ? \
		(dev_zero_fd = open("/dev/zero", O_RDWR), \
		mmap(0, (s), MMAP_PROT, MMAP_FLAGS, dev_zero_fd, 0)) : \
		mmap(0, (s), MMAP_PROT, MMAP_FLAGS, dev_zero_fd, 0))
	#endif /* MAP_ANONYMOUS */

	#define VE_DIRECT_MMAP_DEFAULT(s) VE_MMAP_DEFAULT(s)
...
#else /* MMAP */
#define CALL_MMAP(s)        VE_MMAP_DEFAULT(s)
#endif /* MMAP */
#ifdef MUNMAP
#define CALL_MUNMAP(a, s)   MUNMAP((a), (s))
#else /* MUNMAP */
#define CALL_MUNMAP(a, s)   VE_MUNMAP_DEFAULT((a), (s))
#endif /* MUNMAP */
#ifdef DIRECT_MMAP
#define CALL_DIRECT_MMAP(s) DIRECT_MMAP(s)
#else /* DIRECT_MMAP */
#define CALL_DIRECT_MMAP(s) VE_DIRECT_MMAP_DEFAULT(s)
#endif /* DIRECT_MMAP */
#else  /* HAVE_MMAP */
