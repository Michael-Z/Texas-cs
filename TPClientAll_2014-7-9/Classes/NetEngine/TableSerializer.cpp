...
void TableSerializer::SerializeTable(DataStructures::Table *in, VENet::BitStream *out)
{
...
void TableSerializer::SerializeColumns(DataStructures::Table *in, VENet::BitStream *out)
{
    const DataStructures::List<DataStructures::Table::ColumnDescriptor> &columns=in->GetColumns();
...
void TableSerializer::SerializeColumns(DataStructures::Table *in, VENet::BitStream *out, DataStructures::List<int> &skipColumnIndices)
{
    const DataStructures::List<DataStructures::Table::ColumnDescriptor> &columns=in->GetColumns();
...
{
    VENet::BitStream in((unsigned char*) serializedTable, dataLength, false);
    return DeserializeTable(&in, out);
}
bool TableSerializer::DeserializeTable(VENet::BitStream *in, DataStructures::Table *out)
{
    unsigned rowSize;
...
bool TableSerializer::DeserializeColumns(VENet::BitStream *in, DataStructures::Table *out)
{
    unsigned columnSize;
...
void TableSerializer::SerializeRow(DataStructures::Table::Row *in, unsigned keyIn, const DataStructures::List<DataStructures::Table::ColumnDescriptor> &columns, VENet::BitStream *out)
{
    unsigned cellIndex;
    out->Write(keyIn);
...
void TableSerializer::SerializeRow(DataStructures::Table::Row *in, unsigned keyIn, const DataStructures::List<DataStructures::Table::ColumnDescriptor> &columns, VENet::BitStream *out, DataStructures::List<int> &skipColumnIndices)
{
    unsigned cellIndex;
    out->Write(keyIn);
...
bool TableSerializer::DeserializeRow(VENet::BitStream *in, DataStructures::Table *out)
{
...
void TableSerializer::SerializeCell(VENet::BitStream *out, DataStructures::Table::Cell *cell, DataStructures::Table::ColumnType columnType)
{
    ...
    if (cell->isEmpty==false)
    {
        ...
        {
            VEAssert(columnType==DataStructures::Table::BINARY);
            VEAssert(cell->i>0);
...
bool TableSerializer::DeserializeCell(VENet::BitStream *in, DataStructures::Table::Cell *cell, DataStructures::Table::ColumnType columnType)
{
    bool isEmpty=false;
    double value;
    void *ptr;
...
void TableSerializer::SerializeFilterQuery(VENet::BitStream *in, DataStructures::Table::FilterQuery *query)
{
...
bool TableSerializer::DeserializeFilterQuery(VENet::BitStream *out, DataStructures::Table::FilterQuery *query)
{
    bool b;
    VEAssert(query->cellValue);
...
void TableSerializer::SerializeFilterQueryList(VENet::BitStream *in, DataStructures::Table::FilterQuery *query, unsigned int numQueries, unsigned int maxQueries)
{
    (void) maxQueries;
    ...
    VEAssert(numQueries<=maxQueries);
...
bool TableSerializer::DeserializeFilterQueryList(VENet::BitStream *out, DataStructures::Table::FilterQuery **query, unsigned int *numQueries, unsigned int maxQueries, int allocateExtraQueries)
{
...
void TableSerializer::DeallocateQueryList(DataStructures::Table::FilterQuery *query, unsigned int numQueries)
{
    ...
    unsigned i;
    for (i=0; i < numQueries; i++)
        VENet::OP_DELETE(query[i].cellValue, _FILE_AND_LINE_);
    VENet::OP_DELETE_ARRAY(query, _FILE_AND_LINE_);
}
